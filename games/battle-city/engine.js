/* ==========================================================
   坦克大战(Battle City)引擎 — 纯逻辑,零依赖(UMD)
   Web 版 <script> 与小程序 require 共用同一份算法。
   规范源:games/battle-city/engine.js
   小程序副本:miniprogram/libs/battle-city-engine.js(改动后手动同步)
   规则:场地 208×208(26×26 个 8px 子格)、坦克 16×16、
        每关 20 敌(同屏 ≤4,第 4/11/18 辆为道具坦克)、
        火力 1-4 档(2=快弹 3=双弹 4=破钢+双倍咬砖)、
        6 道具(头盔/时钟/铁锹/星星/炸弹/坦克,+500 分)、
        转向 8px 吸附、子弹子步推进防穿透、友伤=冻结
   随机数经 opts.rng 注入,AI/刷新/道具落点全部可确定性复现
   ========================================================== */
